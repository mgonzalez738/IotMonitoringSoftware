...
import textExtensions from 'https://unpkg.com/textextensions@^5.10.0/edition-deno/index.ts'
import binaryExtensions from 'https://unpkg.com/binaryextensions@^4.14.0/edition-deno/index.ts'
