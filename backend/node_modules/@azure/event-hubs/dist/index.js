...
class ManagementClient extends LinkEntity {
    ...
    getEventHubProperties(options = {}) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                clientSpan.setStatus({ code: api.CanonicalCode.OK });
                return runtimeInfo;
            }
            catch (error) {
    ...
    _init() {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                logger.warning(`[${this._context.connectionId}] An error occured while establishing the $management links: ${err === null || err === void 0 ? void 0 : err.name}: ${err === null || err === void 0 ? void 0 : err.message}`);
                logErrorStackTrace(err);
                throw err;
            }
        });
    ...
    _makeManagementRequest(request, options = {}) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const sendOperationPromise = () => new Promise((resolve, reject) => tslib.__awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        ...
                        logger.warning("[%s] An error occurred during send on management request-response link with address " +
                            "'%s': %s", this._context.connectionId, this.address, `${err === null || err === void 0 ? void 0 : err.name}: ${err === null || err === void 0 ? void 0 : err.message}`);
                        logErrorStackTrace(err);
                        reject(err);
                    }
                }));
                ...
                err = coreAmqp.translate(err);
                logger.warning(`An error occurred while making the request to $management endpoint: ${err === null || err === void 0 ? void 0 : err.name}: ${err === null || err === void 0 ? void 0 : err.message}`);
                logErrorStackTrace(err);
                throw err;
            }
        });
    ...
    _createClientSpan(operationName, parentSpan, internal = false) {
        ...
        const span = tracer.startSpan(`Azure.EventHubs.${operationName}`, {
            kind: internal ? api.SpanKind.INTERNAL : api.SpanKind.CLIENT,
            parent: parentSpan
        });
...
(function (ConnectionContext) {
    ...
    function create(config, tokenCredential, options) {
        ...
        function cleanConnectionContext(connectionContext) {
            ...
            connectionContext.connection.removeListener(rheaPromise.ConnectionEvents.disconnected, onDisconnected);
        ...
        function refreshConnection(connectionContext) {
            return tslib.__awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    logger.verbose(`[${connectionContext.connectionId}] There was an error closing the connection before reconnecting: %O`, err);
                }
...
function createConnectionContext(hostOrConnectionString, eventHubNameOrOptions, credentialOrOptions, options) {
    ...
    if (!coreAmqp.isTokenCredential(credentialOrOptions)) {
        ...
        if (!(parsedCS.EntityPath || (typeof eventHubNameOrOptions === "string" && eventHubNameOrOptions))) {
        ...
        credential = coreAmqp.SharedKeyCredential.fromConnectionString(connectionString);
    }
    else {
...
class PartitionPump {
    ...
    _receiveEvents(partitionId) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            this._receiver = new EventHubReceiver(this._context, this._partitionProcessor.consumerGroup, partitionId, this._startPosition, {
            ...
            while (this._isReceiving) {
                try {
                    ...
                    const span = createProcessingSpan(receivedEvents, {
    ...
    _performLoadBalancing(loadBalancingStrategy, partitionIds, abortSignal) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            for (const partitionToClaim of uniquePartitionsToClaim) {
                let partitionOwnershipRequest;
                partitionOwnershipRequest = this._createPartitionOwnershipRequest(partitionOwnershipMap, partitionToClaim);
 ...
 * @ignore
 */
function createMessageSpan(parentSpan, eventHubConfig) {
    const tracer = coreTracing.getTracer();
        ...
        const sendEventPromise = () => new Promise((resolve, reject) => tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.isOpen()) {
                ...
                try {
                    ...
                    removeListeners();
                    err = coreAmqp.translate(err);
                    logger.warning("[%s] An error occurred while creating the sender %s: %s", this._context.connectionId, this.name, `${err === null || err === void 0 ? void 0 : err.name}: ${err === null || err === void 0 ? void 0 : err.message}`);
                    logErrorStackTrace(err);
                    return reject(err);
                }
            }
            ...
            if (this._sender.sendable()) {
                ...
                try {
                    ...
                    logger.warning("[%s] An error occurred while sending the message %s", this._context.connectionId, `${err === null || err === void 0 ? void 0 : err.name}: ${err === null || err === void 0 ? void 0 : err.message}`);
                    logErrorStackTrace(err);
                    return reject(err);
                }
                finally {
